...
| terra-alert | ^1.8.0 | ^15.4.2 | The Terra Alert component is a notification banner that can be rendered in your application when there is information that you want to bring to the user's attention. The Alert component supports a number of built-in notification types that render with pre-defined colors and icons that help the user understand the severity and meaning of the notification. A custom notification type is also supported that allows your application to customize an alert that may not fit into the pre-defined types. |
...
| terra-article | ^1.0.0 | ^15.4.2 | Mockup for Article Card. Do not publish. |
| terra-badge | ^1.10.0 | ^15.4.2 | terra-badge |
...
| terra-card | ^1.5.0 | ^15.4.2 | Card is a basic container with some base styling to help seperate elements with different content |
| terra-collapsible-menu-view | ^1.0.0 | ^15.4.2 | The collapsible menu view is a mechanism that can be used in toolbar scenarios where actionable items will be displayed face-up and flex based on the space available. Any items that can not fit in the available space will be rolled into an ellipsis menu. |
...
| terra-date-picker | ^1.12.0 | ^15.4.2 | The terra-date-picker component provides users a way to enter or select a date from the date picker. |
| terra-demographics-banner | ^1.11.0 | ^15.4.2 | The demographics component is used to display demographic information about a person in a condensed, easy to read format. |
| terra-dynamic-grid | ^1.5.0 | ^15.4.2 | The terra-dynamic-grid component provides users a way to build dynamic layouts using CSS Grids. |
| terra-embedded-content-consumer | ^1.5.0 | ^15.4.2 | The Embedded Content Consumer is the application component which is embedding web content within it. |
...
| terra-image | ^1.10.0 | ^15.4.2 | terra-image |
